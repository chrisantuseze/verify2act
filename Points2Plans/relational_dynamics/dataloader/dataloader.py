...
class PerSceneLoader(object):
    ...
    # contact arrays, one-hot encodings, voxel/point-cloud loading).
        ...
        ### Only needed if you want discrete placement targets e.g "place on shelf layer 2" rather than just "place at XYZ"
    ...
    def __init__(self, 
        ...
        if config.args.train_dir != None:
            ...
            for train_dir in self.train_pcd_path[start_id:start_id+max_size]:
                ...
                if self.single_step_training:
                    # @Chris - This looks like its creating scene data for each step in the demo
